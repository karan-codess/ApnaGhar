...
const MyProperties = () => { 
    ...
    const handleDelete=async(id)=>{ 
        ...
        try { 
           ...
           alert("failed to delete a roperty")  
        } 
    } 
    ...
    <div className='fade-in'> 
        ...
        <div className='fade-in'> 
            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8 flex-wrap gap-6 my-props-header text-left'> 
                ...
                <Link 
                    to="/add-property" 
                    className='btn btn-primary py-3 px-6 rounded-xl font-bold w-full md:w-auto text-center'
                > 
                    Add Property 
                </Link> 
                ...
                {!Array.isArray(properties)|| properties.length===0?( 
                    ...
                    <div className='card-premium py-24 px-8 text-center'> 
                        ...
                        <p className='text-[#64748b] mb-8'>
                            Start your journey by adding your first listings
                        </p> 
                                        ...
                                        <div className='flex-1 flex gap-2 items-center'> 
                                            ...
                                            <div className='flex-1 relative'> 
                                                ...
                                                <select 
                                                    ...
                                                    className='w-full py-2.5 pr-8 pl-3 text-[0.8125rem] font-semibold rounded-lg border border-[#e2e8f0] bg-white appearance-none cursor-pointer outline-none'
                                                > 
                                            ...
                                            <Link 
                                                ...
                                                className='btn btn-outline p-2.5 text-[0.8125rem] flex items-center justify-center gap-1.5 border border-[#e2e8f0]'
                                            > 
