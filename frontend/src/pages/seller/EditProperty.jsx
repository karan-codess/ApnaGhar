    ...
    <div className="fade-in px-4 py-8 md:py-12 w-full mx-auto dashboard-content">
      <div className="max-w-[900px] w-full mx-auto">
        ...
        <form onSubmit={handleSubmit} className="card-premium p-6 md:p-10">
          {error && (
            <div className="p-4 bg-[#fee2e2] text-[#dc2626] rounded-xl mb-8">
              {error}
            </div>
          )}
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-4">
              ...
              {existingImages.map((src, i) => (
                <div
                  key={`existing-${i}`}
                  className="relative aspect-square rounded-xl overflow-hidden border-2 border-[#f1f5f9]"
                >
                  <img
                    src={src}
                    alt="Existing"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-primary text-white text-[0.6rem] text-center py-0.5 font-bold tracking-widest">
                    EXISTING
                  </div>
                </div>
              ))}
              ...
              {newImagePreviews.map((src, i) => (
                <div
                  key={`new-${i}`}
                  className="relative aspect-square rounded-xl overflow-hidden border-2 border-dashed border-primary"
                >
                  <img
                    src={src}
                    alt="New Preview"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-[#10b981] text-white text-[0.6rem] text-center py-0.5 font-bold tracking-widest">
                    NEW
                  </div>
                </div>
              ))}
