...
const AdminDashboard = () => {
  ...
  <div className="flex justify-between items-start mb-8 flex-wrap gap-6">
    <div>
      ...
      <p className="text-text-muted text-[0.9375rem]">Welcome back</p>
    </div>
    <button
      onClick={() => {
        setLoading(true);
  ...
  <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-5 mb-12">
    {statCards.map((card, i) => (
      <div key={i} className="card-premium p-6 flex flex-col gap-4">
        <div
          className="w-11 h-11 rounded-[0.875rem] flex items-center justify-center"
          style={{
        ...
        <div>
          <div className="text-[0.8125rem] font-semibold text-text-muted mb-1">
            {card.title}
          </div>
          <div className="text-[1.75rem] font-extrabold text-text-main">
        ...
        (service, i) => (
          <div key={i} className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[0.8125rem] text-[#10b981] font-bold">
                Online
              </span>
            </div>
          </div>
  ...
  <div className="card-premium p-6 bg-primary text-white">
    ...
    <div className="flex flex-col gap-3">
      <button className="btn bg-white/20 text-white w-full justify-start text-[0.875rem]">
        System Logs
      </button>
      <button className="btn bg-white/20 text-white w-full justify-start text-[0.875rem]">
        DB Backup
