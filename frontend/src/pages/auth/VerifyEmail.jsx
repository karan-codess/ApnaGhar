...
const VerifyEmail = () => {
    ...
    const emailFromEstate=location.state?.email ||""
    const [email,setEmail]=useState(emailFromEstate)
    ...
    <div className='bg-bg-alt min-h-screen pt-32 max-lg:pt-28'>
        <div className='container flex justify-center items-center pt-16 sm:pt-8'>
            <div className='glass fade-in w-full max-w-[450px] p-10 sm:p-6 rounded-3xl sm:rounded-2xl shadow-card'>
                ...
                <p className='text-center text-text-muted mb-8'>Enter the 6-digit code sent to your email</p>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
                    ...
                    <div>
                        ...
                        <input type="text" maxLength="6" placeholder='123123' value={code} onChange={(e)=>setCode(e.target.value)}
                        required
